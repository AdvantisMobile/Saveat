...
class CartAgradecimentoPage extends StatefulWidget {

  final String pedidoId;

  CartAgradecimentoPage(this.pedidoId);

  @override
  _CartAgradecimentoPageState createState() => _CartAgradecimentoPageState();
}

class _CartAgradecimentoPageState extends State<CartAgradecimentoPage> {
  ...
  void didChangeDependencies() async {
    ...
    if(!_loaded){
      _loaded = !_loaded;
      await usuarioProvider.getPedido(context, widget.pedidoId);
    }
